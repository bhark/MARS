//! mars artifact container codec. on-disk layout per FORMAT.md.
...
pub use geometry::{
    ...
    GeomVisitor, GeometryPayload, decode_geometry_at_slots, decode_geometry_payload, decode_geometry_payload_filtered,
    decode_one_geom, encode_geometry_payload, iter_feature_index, visit_one_geom,
};
