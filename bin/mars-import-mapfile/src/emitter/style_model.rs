...
pub(crate) fn anchor_position_yaml(p: mars_style::AnchorPosition) -> &'static str {
...
pub(crate) fn line_angle_mode_yaml(m: mars_style::LineAngleMode) -> &'static str {
...
pub(crate) fn blend_mode_yaml(b: mars_style::BlendMode) -> &'static str {
