...
INSERT INTO mars_diff.parcels (gid, kind, geom) VALUES
    (1, 'park',  ST_GeomFromText('POLYGON((100 100, 300 100, 300 300, 100 300, 100 100))', 25832)),
    (2, 'park',  ST_GeomFromText('POLYGON((400 100, 600 100, 600 300, 400 300, 400 100))', 25832)),
    (3, 'road',  ST_GeomFromText('POLYGON((100 400, 900 400, 900 500, 100 500, 100 400))', 25832)),
    (4, 'water', ST_GeomFromText('POLYGON((100 600, 400 600, 400 900, 100 900, 100 600))', 25832)),
    (5, 'water', ST_GeomFromText('POLYGON((500 600, 800 600, 800 900, 500 900, 500 600))', 25832)),
    (6, 'park',  ST_GeomFromText('POLYGON((700 100, 900 100, 900 300, 700 300, 700 100))', 25832)),
