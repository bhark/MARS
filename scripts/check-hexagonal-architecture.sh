...
is_adapter()  { [[ "$1" == "mars-source-postgres" || "$1" == "mars-source-xyz" || "$1" == "mars-store-s3" || "$1" == "mars-store-fs" || "$1" == "mars-render" || "$1" == "mars-definition-source-inline" || "$1" == "mars-definition-source-configmap" || "$1" == "mars-definition-source-git" ]]; }
